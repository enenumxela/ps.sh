...
Please don't open a GitHub issue for questions about how to use `ps.sh`, as the goal is to use issues for managing bugs and feature requests. Issues that are related to general support will be closed.

## Found a Bug?

If you've identified a bug in `ps.sh`, please [submit an issue](#create-an-issue) to our GitHub repo: [enenumxela/ps.sh](https://github.com/enenumxela/ps.sh/issues/new). Please also feel free to submit a [Pull Request](#pull-requests) with a fix for the bug!
...
New issues can be created with in our [GitHub repo](https://github.com/enenumxela/ps.sh/issues/new).
...
By contributing your code, you agree to license your contribution under the terms of the [MIT License](https://github.com/enenumxela/ps.sh/blob/master/LICENSE).
